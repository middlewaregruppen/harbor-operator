...
// IsSuccess returns true when this get g c log o k response has a 2xx status code
func (o *GetGCLogOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get g c log o k response has a 3xx status code
func (o *GetGCLogOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c log o k response has a 4xx status code
func (o *GetGCLogOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get g c log o k response has a 5xx status code
func (o *GetGCLogOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c log o k response a status code equal to that given
...
// IsSuccess returns true when this get g c log bad request response has a 2xx status code
func (o *GetGCLogBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c log bad request response has a 3xx status code
func (o *GetGCLogBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c log bad request response has a 4xx status code
func (o *GetGCLogBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this get g c log bad request response has a 5xx status code
func (o *GetGCLogBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c log bad request response a status code equal to that given
...
// IsSuccess returns true when this get g c log unauthorized response has a 2xx status code
func (o *GetGCLogUnauthorized) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c log unauthorized response has a 3xx status code
func (o *GetGCLogUnauthorized) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c log unauthorized response has a 4xx status code
func (o *GetGCLogUnauthorized) IsClientError() bool {
	return true
}

// IsServerError returns true when this get g c log unauthorized response has a 5xx status code
func (o *GetGCLogUnauthorized) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c log unauthorized response a status code equal to that given
...
// IsSuccess returns true when this get g c log forbidden response has a 2xx status code
func (o *GetGCLogForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c log forbidden response has a 3xx status code
func (o *GetGCLogForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c log forbidden response has a 4xx status code
func (o *GetGCLogForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get g c log forbidden response has a 5xx status code
func (o *GetGCLogForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c log forbidden response a status code equal to that given
...
// IsSuccess returns true when this get g c log not found response has a 2xx status code
func (o *GetGCLogNotFound) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c log not found response has a 3xx status code
func (o *GetGCLogNotFound) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c log not found response has a 4xx status code
func (o *GetGCLogNotFound) IsClientError() bool {
	return true
}

// IsServerError returns true when this get g c log not found response has a 5xx status code
func (o *GetGCLogNotFound) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c log not found response a status code equal to that given
...
// IsSuccess returns true when this get g c log internal server error response has a 2xx status code
func (o *GetGCLogInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c log internal server error response has a 3xx status code
func (o *GetGCLogInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c log internal server error response has a 4xx status code
func (o *GetGCLogInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this get g c log internal server error response has a 5xx status code
func (o *GetGCLogInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this get g c log internal server error response a status code equal to that given
