...
// IsSuccess returns true when this get g c schedule o k response has a 2xx status code
func (o *GetGCScheduleOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get g c schedule o k response has a 3xx status code
func (o *GetGCScheduleOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c schedule o k response has a 4xx status code
func (o *GetGCScheduleOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get g c schedule o k response has a 5xx status code
func (o *GetGCScheduleOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c schedule o k response a status code equal to that given
...
// IsSuccess returns true when this get g c schedule unauthorized response has a 2xx status code
func (o *GetGCScheduleUnauthorized) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c schedule unauthorized response has a 3xx status code
func (o *GetGCScheduleUnauthorized) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c schedule unauthorized response has a 4xx status code
func (o *GetGCScheduleUnauthorized) IsClientError() bool {
	return true
}

// IsServerError returns true when this get g c schedule unauthorized response has a 5xx status code
func (o *GetGCScheduleUnauthorized) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c schedule unauthorized response a status code equal to that given
...
// IsSuccess returns true when this get g c schedule forbidden response has a 2xx status code
func (o *GetGCScheduleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c schedule forbidden response has a 3xx status code
func (o *GetGCScheduleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c schedule forbidden response has a 4xx status code
func (o *GetGCScheduleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get g c schedule forbidden response has a 5xx status code
func (o *GetGCScheduleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c schedule forbidden response a status code equal to that given
...
// IsSuccess returns true when this get g c schedule internal server error response has a 2xx status code
func (o *GetGCScheduleInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c schedule internal server error response has a 3xx status code
func (o *GetGCScheduleInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c schedule internal server error response has a 4xx status code
func (o *GetGCScheduleInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this get g c schedule internal server error response has a 5xx status code
func (o *GetGCScheduleInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this get g c schedule internal server error response a status code equal to that given
