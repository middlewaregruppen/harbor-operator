...
// IsSuccess returns true when this update g c schedule o k response has a 2xx status code
func (o *UpdateGCScheduleOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update g c schedule o k response has a 3xx status code
func (o *UpdateGCScheduleOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update g c schedule o k response has a 4xx status code
func (o *UpdateGCScheduleOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this update g c schedule o k response has a 5xx status code
func (o *UpdateGCScheduleOK) IsServerError() bool {
	return false
}

// IsCode returns true when this update g c schedule o k response a status code equal to that given
...
// IsSuccess returns true when this update g c schedule bad request response has a 2xx status code
func (o *UpdateGCScheduleBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update g c schedule bad request response has a 3xx status code
func (o *UpdateGCScheduleBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update g c schedule bad request response has a 4xx status code
func (o *UpdateGCScheduleBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update g c schedule bad request response has a 5xx status code
func (o *UpdateGCScheduleBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update g c schedule bad request response a status code equal to that given
...
// IsSuccess returns true when this update g c schedule unauthorized response has a 2xx status code
func (o *UpdateGCScheduleUnauthorized) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update g c schedule unauthorized response has a 3xx status code
func (o *UpdateGCScheduleUnauthorized) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update g c schedule unauthorized response has a 4xx status code
func (o *UpdateGCScheduleUnauthorized) IsClientError() bool {
	return true
}

// IsServerError returns true when this update g c schedule unauthorized response has a 5xx status code
func (o *UpdateGCScheduleUnauthorized) IsServerError() bool {
	return false
}

// IsCode returns true when this update g c schedule unauthorized response a status code equal to that given
...
// IsSuccess returns true when this update g c schedule forbidden response has a 2xx status code
func (o *UpdateGCScheduleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update g c schedule forbidden response has a 3xx status code
func (o *UpdateGCScheduleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update g c schedule forbidden response has a 4xx status code
func (o *UpdateGCScheduleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update g c schedule forbidden response has a 5xx status code
func (o *UpdateGCScheduleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update g c schedule forbidden response a status code equal to that given
...
// IsSuccess returns true when this update g c schedule internal server error response has a 2xx status code
func (o *UpdateGCScheduleInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update g c schedule internal server error response has a 3xx status code
func (o *UpdateGCScheduleInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update g c schedule internal server error response has a 4xx status code
func (o *UpdateGCScheduleInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this update g c schedule internal server error response has a 5xx status code
func (o *UpdateGCScheduleInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this update g c schedule internal server error response a status code equal to that given
