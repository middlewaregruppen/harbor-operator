...
// IsSuccess returns true when this get g c o k response has a 2xx status code
func (o *GetGCOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get g c o k response has a 3xx status code
func (o *GetGCOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c o k response has a 4xx status code
func (o *GetGCOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get g c o k response has a 5xx status code
func (o *GetGCOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c o k response a status code equal to that given
...
// IsSuccess returns true when this get g c unauthorized response has a 2xx status code
func (o *GetGCUnauthorized) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c unauthorized response has a 3xx status code
func (o *GetGCUnauthorized) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c unauthorized response has a 4xx status code
func (o *GetGCUnauthorized) IsClientError() bool {
	return true
}

// IsServerError returns true when this get g c unauthorized response has a 5xx status code
func (o *GetGCUnauthorized) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c unauthorized response a status code equal to that given
...
// IsSuccess returns true when this get g c forbidden response has a 2xx status code
func (o *GetGCForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c forbidden response has a 3xx status code
func (o *GetGCForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c forbidden response has a 4xx status code
func (o *GetGCForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get g c forbidden response has a 5xx status code
func (o *GetGCForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c forbidden response a status code equal to that given
...
// IsSuccess returns true when this get g c not found response has a 2xx status code
func (o *GetGCNotFound) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c not found response has a 3xx status code
func (o *GetGCNotFound) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c not found response has a 4xx status code
func (o *GetGCNotFound) IsClientError() bool {
	return true
}

// IsServerError returns true when this get g c not found response has a 5xx status code
func (o *GetGCNotFound) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c not found response a status code equal to that given
...
// IsSuccess returns true when this get g c internal server error response has a 2xx status code
func (o *GetGCInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c internal server error response has a 3xx status code
func (o *GetGCInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c internal server error response has a 4xx status code
func (o *GetGCInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this get g c internal server error response has a 5xx status code
func (o *GetGCInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this get g c internal server error response a status code equal to that given
