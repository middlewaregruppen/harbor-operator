...
// IsSuccess returns true when this create g c schedule created response has a 2xx status code
func (o *CreateGCScheduleCreated) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this create g c schedule created response has a 3xx status code
func (o *CreateGCScheduleCreated) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create g c schedule created response has a 4xx status code
func (o *CreateGCScheduleCreated) IsClientError() bool {
	return false
}

// IsServerError returns true when this create g c schedule created response has a 5xx status code
func (o *CreateGCScheduleCreated) IsServerError() bool {
	return false
}

// IsCode returns true when this create g c schedule created response a status code equal to that given
...
// IsSuccess returns true when this create g c schedule bad request response has a 2xx status code
func (o *CreateGCScheduleBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create g c schedule bad request response has a 3xx status code
func (o *CreateGCScheduleBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create g c schedule bad request response has a 4xx status code
func (o *CreateGCScheduleBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this create g c schedule bad request response has a 5xx status code
func (o *CreateGCScheduleBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this create g c schedule bad request response a status code equal to that given
...
// IsSuccess returns true when this create g c schedule unauthorized response has a 2xx status code
func (o *CreateGCScheduleUnauthorized) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create g c schedule unauthorized response has a 3xx status code
func (o *CreateGCScheduleUnauthorized) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create g c schedule unauthorized response has a 4xx status code
func (o *CreateGCScheduleUnauthorized) IsClientError() bool {
	return true
}

// IsServerError returns true when this create g c schedule unauthorized response has a 5xx status code
func (o *CreateGCScheduleUnauthorized) IsServerError() bool {
	return false
}

// IsCode returns true when this create g c schedule unauthorized response a status code equal to that given
...
// IsSuccess returns true when this create g c schedule forbidden response has a 2xx status code
func (o *CreateGCScheduleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create g c schedule forbidden response has a 3xx status code
func (o *CreateGCScheduleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create g c schedule forbidden response has a 4xx status code
func (o *CreateGCScheduleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create g c schedule forbidden response has a 5xx status code
func (o *CreateGCScheduleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create g c schedule forbidden response a status code equal to that given
...
// IsSuccess returns true when this create g c schedule conflict response has a 2xx status code
func (o *CreateGCScheduleConflict) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create g c schedule conflict response has a 3xx status code
func (o *CreateGCScheduleConflict) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create g c schedule conflict response has a 4xx status code
func (o *CreateGCScheduleConflict) IsClientError() bool {
	return true
}

// IsServerError returns true when this create g c schedule conflict response has a 5xx status code
func (o *CreateGCScheduleConflict) IsServerError() bool {
	return false
}

// IsCode returns true when this create g c schedule conflict response a status code equal to that given
...
// IsSuccess returns true when this create g c schedule internal server error response has a 2xx status code
func (o *CreateGCScheduleInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create g c schedule internal server error response has a 3xx status code
func (o *CreateGCScheduleInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create g c schedule internal server error response has a 4xx status code
func (o *CreateGCScheduleInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this create g c schedule internal server error response has a 5xx status code
func (o *CreateGCScheduleInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this create g c schedule internal server error response a status code equal to that given
