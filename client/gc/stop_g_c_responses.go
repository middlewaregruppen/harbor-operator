...
// IsSuccess returns true when this stop g c o k response has a 2xx status code
func (o *StopGCOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this stop g c o k response has a 3xx status code
func (o *StopGCOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this stop g c o k response has a 4xx status code
func (o *StopGCOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this stop g c o k response has a 5xx status code
func (o *StopGCOK) IsServerError() bool {
	return false
}

// IsCode returns true when this stop g c o k response a status code equal to that given
...
// IsSuccess returns true when this stop g c unauthorized response has a 2xx status code
func (o *StopGCUnauthorized) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this stop g c unauthorized response has a 3xx status code
func (o *StopGCUnauthorized) IsRedirect() bool {
	return false
}

// IsClientError returns true when this stop g c unauthorized response has a 4xx status code
func (o *StopGCUnauthorized) IsClientError() bool {
	return true
}

// IsServerError returns true when this stop g c unauthorized response has a 5xx status code
func (o *StopGCUnauthorized) IsServerError() bool {
	return false
}

// IsCode returns true when this stop g c unauthorized response a status code equal to that given
...
// IsSuccess returns true when this stop g c forbidden response has a 2xx status code
func (o *StopGCForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this stop g c forbidden response has a 3xx status code
func (o *StopGCForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this stop g c forbidden response has a 4xx status code
func (o *StopGCForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this stop g c forbidden response has a 5xx status code
func (o *StopGCForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this stop g c forbidden response a status code equal to that given
...
// IsSuccess returns true when this stop g c not found response has a 2xx status code
func (o *StopGCNotFound) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this stop g c not found response has a 3xx status code
func (o *StopGCNotFound) IsRedirect() bool {
	return false
}

// IsClientError returns true when this stop g c not found response has a 4xx status code
func (o *StopGCNotFound) IsClientError() bool {
	return true
}

// IsServerError returns true when this stop g c not found response has a 5xx status code
func (o *StopGCNotFound) IsServerError() bool {
	return false
}

// IsCode returns true when this stop g c not found response a status code equal to that given
...
// IsSuccess returns true when this stop g c internal server error response has a 2xx status code
func (o *StopGCInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this stop g c internal server error response has a 3xx status code
func (o *StopGCInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this stop g c internal server error response has a 4xx status code
func (o *StopGCInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this stop g c internal server error response has a 5xx status code
func (o *StopGCInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this stop g c internal server error response a status code equal to that given
