...
type ClientService interface {
	...
	StopGC(params *StopGCParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*StopGCOK, error)
...
/*
StopGC stops the specific g c execution

Stop the GC execution specified by ID
*/
func (a *Client) StopGC(params *StopGCParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*StopGCOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewStopGCParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "stopGC",
		Method:             "PUT",
