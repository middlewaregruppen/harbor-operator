...
// IsSuccess returns true when this get g c history o k response has a 2xx status code
func (o *GetGCHistoryOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get g c history o k response has a 3xx status code
func (o *GetGCHistoryOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c history o k response has a 4xx status code
func (o *GetGCHistoryOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get g c history o k response has a 5xx status code
func (o *GetGCHistoryOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c history o k response a status code equal to that given
...
// IsSuccess returns true when this get g c history unauthorized response has a 2xx status code
func (o *GetGCHistoryUnauthorized) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c history unauthorized response has a 3xx status code
func (o *GetGCHistoryUnauthorized) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c history unauthorized response has a 4xx status code
func (o *GetGCHistoryUnauthorized) IsClientError() bool {
	return true
}

// IsServerError returns true when this get g c history unauthorized response has a 5xx status code
func (o *GetGCHistoryUnauthorized) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c history unauthorized response a status code equal to that given
...
// IsSuccess returns true when this get g c history forbidden response has a 2xx status code
func (o *GetGCHistoryForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c history forbidden response has a 3xx status code
func (o *GetGCHistoryForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c history forbidden response has a 4xx status code
func (o *GetGCHistoryForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get g c history forbidden response has a 5xx status code
func (o *GetGCHistoryForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c history forbidden response a status code equal to that given
...
// IsSuccess returns true when this get g c history internal server error response has a 2xx status code
func (o *GetGCHistoryInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c history internal server error response has a 3xx status code
func (o *GetGCHistoryInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c history internal server error response has a 4xx status code
func (o *GetGCHistoryInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this get g c history internal server error response has a 5xx status code
func (o *GetGCHistoryInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this get g c history internal server error response a status code equal to that given
