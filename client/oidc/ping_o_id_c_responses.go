...
// IsSuccess returns true when this ping o Id c o k response has a 2xx status code
func (o *PingOIDCOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this ping o Id c o k response has a 3xx status code
func (o *PingOIDCOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ping o Id c o k response has a 4xx status code
func (o *PingOIDCOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this ping o Id c o k response has a 5xx status code
func (o *PingOIDCOK) IsServerError() bool {
	return false
}

// IsCode returns true when this ping o Id c o k response a status code equal to that given
...
// IsSuccess returns true when this ping o Id c bad request response has a 2xx status code
func (o *PingOIDCBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ping o Id c bad request response has a 3xx status code
func (o *PingOIDCBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ping o Id c bad request response has a 4xx status code
func (o *PingOIDCBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ping o Id c bad request response has a 5xx status code
func (o *PingOIDCBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ping o Id c bad request response a status code equal to that given
...
// IsSuccess returns true when this ping o Id c unauthorized response has a 2xx status code
func (o *PingOIDCUnauthorized) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ping o Id c unauthorized response has a 3xx status code
func (o *PingOIDCUnauthorized) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ping o Id c unauthorized response has a 4xx status code
func (o *PingOIDCUnauthorized) IsClientError() bool {
	return true
}

// IsServerError returns true when this ping o Id c unauthorized response has a 5xx status code
func (o *PingOIDCUnauthorized) IsServerError() bool {
	return false
}

// IsCode returns true when this ping o Id c unauthorized response a status code equal to that given
...
// IsSuccess returns true when this ping o Id c forbidden response has a 2xx status code
func (o *PingOIDCForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ping o Id c forbidden response has a 3xx status code
func (o *PingOIDCForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ping o Id c forbidden response has a 4xx status code
func (o *PingOIDCForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this ping o Id c forbidden response has a 5xx status code
func (o *PingOIDCForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this ping o Id c forbidden response a status code equal to that given
